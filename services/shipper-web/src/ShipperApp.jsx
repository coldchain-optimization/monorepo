...
export default function ShipperApp() {
  ...
  useEffect(() => {
    const fetchPrice = async () => {
      setIsPricing(true);
      try {
        const res = await api.getLivePriceQuote({
          distance_km: 300,
          load_tons: loadWeight / 1000,
          fuel_price: 90,
          toll_cost: 15,
        });
        setEstimatedCost(res.trip_price_rs || 5000);
      } catch (e) {
  ...
  }, [source, destination, loadWeight, token, tab]);
  ...
  const handleCreateShipment = async () => {
    ...
    try {
      ...
      setSuccess(
        `Shipment created successfully: ${shipment.source_location} -> ${shipment.destination_location}`,
      );
    ...
    return (
      <div className="min-h-screen flex text-white bg-background relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div
            className="absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] rounded-full bg-secondary/10 blur-[150px] animate-blob"
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 w-full max-w-7xl mx-auto items-center">
          ...
          <div className="w-full max-w-md glass-panel p-8 sm:p-10 shadow-2xl">
            ...
            <h2 className="text-3xl font-extrabold text-center text-white tracking-tight mb-2">
              Shipper Portal
            </h2>
            ...
            <div className="space-y-6">
              ...
              <div className="mt-8 text-center text-sm text-slate-400 glass-panel border-none p-4 bg-white/5">
                ...
                <span className="px-2 py-1 rounded bg-black/40 font-mono text-secondary text-xs">
                  shipper1@looplink.com
                </span>
  ...
  return (
    <div className="min-h-screen bg-background relative font-sans text-white pb-12 flex flex-col overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div
          className="absolute top-[40%] right-[-10%] w-[600px] h-[600px] rounded-full bg-secondary/10 blur-[150px] animate-blob"
          style={{ animationDelay: "2s" }}
        ></div>
      </div>
          ...
          <div className="max-w-[780px] mx-auto animate-fade-in-up">
            <div className="glass-panel shadow-[0_25px_50px_rgba(0,0,0,0.4)] overflow-hidden relative group">
              ...
              <div className="px-8 py-8 border-b border-white/10 glass-panel">
                ...
                <p className="text-slate-400 mt-3 text-center font-medium">
                  Broadcast a fast, reliable freight request to our carrier
                  network.
                </p>
              </div>
              ...
              <div className="p-8 space-y-10">
                ...
                <div className="relative p-6 rounded-2xl bg-white/[0.02] border border-white/5 transition-all hover:bg-white/[0.04]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      ...
                      <div className="relative group">
                        <Package
                          className="absolute left-4 top-1/2 transform -translate-y-1/2 text-primary pointer-events-none group-focus-within:text-white transition-colors"
                          size={18}
                        />
                        <select
                          value={loadType}
                        ...
                        >
                          <option className="bg-[#1E2130] text-white">
                            Vegetables
                          </option>
                          <option className="bg-[#1E2130] text-white">
                            Fruits
                    ...
                    <div>
                      ...
                      <div className="relative group">
                        <Weight
                          className="absolute left-4 top-1/2 transform -translate-y-1/2 text-primary pointer-events-none group-focus-within:text-yellow-400 transition-colors"
                          size={18}
                        />
                        <input
                          type="number"
                ...
                <div className="relative p-6 rounded-2xl bg-white/[0.02] border border-white/5 transition-all hover:bg-white/[0.04]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                      <label className="text-[13px] font-medium text-slate-400 mb-2 uppercase tracking-wide flex items-center gap-2">
                        Min Temp
                        <div className="w-2 h-2 rounded-full shadow-[0_0_5px_currentColor] text-blue-400 bg-current"></div>
                      </label>
                      <div className="relative group">
                        <Thermometer
                          className="absolute left-4 top-1/2 transform -translate-y-1/2 text-blue-400 pointer-events-none"
                          size={18}
                        />
                        <input
                          type="number"
                          ...
                          className="w-full pl-11 pr-4 dark-input focus:border-blue-400 focus:ring-blue-400"
                        />
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="relative group">
                        <Thermometer
                          className="absolute left-4 top-1/2 transform -translate-y-1/2 text-red-500 pointer-events-none"
                          size={18}
                        />
                        <input
                          type="number"
                          ...
                          className="w-full pl-11 pr-4 dark-input focus:border-red-500 focus:ring-red-500"
                        />
                      </div>
                    </div>
                    <div>
                      <label className="block text-[13px] font-bold text-secondary mb-2 uppercase tracking-wide opacity-90 drop-shadow">
                        Est. Payout
                      </label>
                      <div className="relative group">
                        <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-[#10B981] drop-shadow-[0_0_5px_rgba(16,185,129,0.5)] font-bold text-xl pointer-events-none">
                          ₹
                        </span>
                        <input
                          type="number"
                          ...
                          className="w-full pl-10 pr-4 py-3.5 bg-[#10B981]/10 border border-[#10B981]/30 rounded-xl text-lg font-extrabold focus:border-[#10B981] focus:ring-1 focus:ring-[#10B981] text-[#10B981] shadow-[0_0_15px_rgba(16,185,129,0.15)] focus:shadow-[0_0_20px_rgba(16,185,129,0.3)] transition-all duration-200 outline-none"
                        />
                      </div>
                    </div>
                  </div>
              ...
              <div className="px-8 py-6 border-t border-white/10 bg-white/[0.01] flex justify-end items-center gap-4">
                ...
                >
                  ...
                  {loading ? (
                    ...
                    <>
                      <Truck size={22} /> Broadcast Request
                    </>
                  )}
                </button>
              </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                <h2 className="text-2xl font-extrabold text-white">
                  Your Broadcasted Requests
                </h2>
                <p className="text-slate-400 font-medium">
                  Manage and track your active load postings
                </p>
              </div>
              <button
              ...
              >
                <Loader2
                  size={18}
                  className={
                    loading ? "animate-spin text-primary" : "text-slate-400"
                  }
                />
            ...
            {shipments.length === 0 ? (
              <div className="glass-panel p-16 flex flex-col items-center justify-center text-center shadow-lg">
                ...
                <p className="text-slate-400 font-medium max-w-sm mb-6">
                  You haven't broadcasted any shipments yet. Create one to get
                  started.
                </p>
                <button
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {shipments.map((s) => (
                  <div
                    key={s.id}
                    className="glass-panel p-6 hover:bg-white/[0.04] hover:shadow-[0_0_25px_rgba(0,0,0,0.5)] hover:border-white/20 transition-all duration-300 relative overflow-hidden flex flex-col h-full group"
                  >
                    {/* Top Accent Gradient */}
                    ...
                    <div className="flex justify-between items-start mb-6">
                      ...
                      <div
                        className={`text-xs font-extrabold px-3 py-1.5 rounded-lg uppercase tracking-wide border ${
                    ...
                    <div className="mt-8 space-y-1 bg-white/[0.02] rounded-2xl border border-white/[0.05] p-2">
                      ...
                      <div className="flex justify-between items-center p-3 hover:bg-white/[0.03] rounded-xl transition-colors">
                        ...
                        <span className="text-[15px] font-extrabold text-white">
                          {s.temperature_min !== undefined
                            ? `${s.temperature_min}° - ${s.temperature_max}°`
                            : s.required_temp !== undefined &&
                                s.required_temp !== -1
                              ? `${s.required_temp}°C`
                              : "Any"}
                        </span>
                      ...
                      <div className="flex justify-between items-center p-3 hover:bg-white/[0.03] rounded-xl transition-colors bg-white/[0.02]">
                        ...
                        <span className="text-[16px] font-extrabold text-[#10B981] drop-shadow-[0_0_3px_rgba(16,185,129,0.3)]">
                          ₹{s.estimated_cost}
                        </span>
                      </div>
                    </div>
          ...
          <div className="max-w-4xl mx-auto mt-12 animate-fade-in-up">
            <div className="glass-panel p-16 flex flex-col items-center justify-center text-center shadow-[0_0_30px_rgba(0,0,0,0.5)]">
              ...
              <p className="text-slate-400 font-medium max-w-md text-lg">
                Accepted shipments will appear here once they are assigned by a
                carrier and confirmed by admin.
              </p>
            </div>
          </div>
        )}
