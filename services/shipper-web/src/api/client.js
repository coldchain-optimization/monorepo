...
class ApiClient {
  ...
  async login(email, password) {
    const res = await this.request("POST", "/public/auth/login", {
      email,
      password,
    });
    this.setToken(res.token);
  ...
  async getDriverVehicles(driverId) {
    return this.request(
      "GET",
      `/drivers/${encodeURIComponent(driverId)}/vehicles`,
    );
  }
  ...
  async getBackhauling(shipmentId) {
    return this.request(
      "GET",
      `/matching/backhauling/${encodeURIComponent(shipmentId)}`,
    );
  }
  ...
  async getConsolidationOpportunities(shipmentId) {
    return this.request(
      "GET",
      `/consolidations/${encodeURIComponent(shipmentId)}`,
    );
  }
  ...
  async getBackhaulOpportunities(tripId) {
    return this.request(
      "GET",
      `/trips/${encodeURIComponent(tripId)}/backhauling`,
    );
  }
  ...
  async getTrackingStatus(shipmentId) {
    return this.request(
      "GET",
      `/tracking/${encodeURIComponent(shipmentId)}/status`,
    );
  }
  ...
  async getTrackingHistory(shipmentId) {
    return this.request(
      "GET",
      `/tracking/${encodeURIComponent(shipmentId)}/history`,
    );
  }
  ...
  async getStatusHistory(shipmentId) {
    return this.request(
      "GET",
      `/status/${encodeURIComponent(shipmentId)}/history`,
    );
  }
  ...
  async getCurrentStatus(shipmentId) {
    return this.request(
      "GET",
      `/status/${encodeURIComponent(shipmentId)}/current`,
    );
  }
  ...
  async getStatusSummary(shipmentId) {
    return this.request(
      "GET",
      `/status/${encodeURIComponent(shipmentId)}/summary`,
    );
  }
  ...
  async recordPickupEvent(shipmentId, data) {
    return this.request(
      "POST",
      `/status/${encodeURIComponent(shipmentId)}/pickup`,
      data,
    );
  }
  ...
  async recordDeliveryEvent(shipmentId, data) {
    return this.request(
      "POST",
      `/status/${encodeURIComponent(shipmentId)}/deliver`,
      data,
    );
  }

  // ML Endpoints
  async getLivePriceQuote(data) {
    return this.request("POST", "/ml/price", data);
  }

  async optimizeRoute(data) {
    return this.request("POST", "/ml/optimize_route", data);
  }

  async getTripAnalytics(data) {
    return this.request("POST", "/ml/trip_analytics", data);
  }

  async getEfficiencyMetrics(data) {
    return this.request("POST", "/ml/efficiency_metrics", data);
  }
